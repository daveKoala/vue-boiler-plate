<template>
  <div>
    ...
    >
      <table>
        <caption id="HeadersCol">
          Books with a Fixed Row Header Column
        </caption>
        <thead>
          <tr>
            <th>Author</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              The Method of Fluxions and Infinite Series: With Its Application
              to the Geometry of Curve-lines
            </td>
            <td>1763</td>
            <td>9781330454862</td>
            <td>1330454863</td>
